...
## Datasets
All the annotated datasets with train-test splits for 3 seeds are available in [GitHub folder](https://github.com/gtfintechlab/fomc-hawkish-dovish/tree/main/training_data/test-and-training](https://github.com/TheMonarch00/fomc-hawkish-dovish-reproduced/tree/main/training_data/test-and-training)https://github.com/TheMonarch00/fomc-hawkish-dovish-reproduced/tree/main/training_data/test-and-training)
